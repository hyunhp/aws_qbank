...
ICON_TERMS = {
    ...
    "aws-fargate": ["fargate"], "amazon-q": ["amazon q", "q business"], "amazon-devops-guru": ["devops guru"], "amazon-bedrock": ["bedrock", "knowledge base", "agentcore", "guardrail", "model", "fm"],
    "amazon-textract": ["textract", "ocr"], "aws-outposts-family": ["outposts"], "aws-wavelength": ["wavelength"], "aws-lake-formation": ["lake formation"], "amazon-redshift": ["redshift"], "aws-glue-crawler": ["crawler"], "amazon-dynamodb-stream": ["stream"], "aws-glue-data-catalog": ["catalog", "metastore"],
    "amazon-managed-workflows-for-apache-airflow": ["airflow", "mwaa"], "amazon-sagemaker-ai": ["sagemaker"], "amazon-managed-streaming-for-apache-kafka": ["msk", "kafka"], "amazon-opensearch-service": ["opensearch"], "aws-health-dashboard": ["health"], "amazon-eventbridge-pipes": ["pipes"],
    "amazon-cloudwatch-synthetics": ["synthetics", "canary"], "amazon-ec2-image-builder": ["image builder"], "amazon-elastic-container-registry": ["ecr", "image"],
    "amazon-application-recovery-controller": ["recovery controller", "arc"], "aws-codeartifact": ["codeartifact"], "aws-appconfig": ["appconfig"],
    "aws-codebuild": ["codebuild", "build"], "aws-codepipeline": ["codepipeline", "pipeline"], "aws-systems-manager": ["systems manager", "ssm", "automation"], "aws-signer": ["signer", "sign"], "aws-cloudhsm": ["cloudhsm", "hsm"], "amazon-simple-storage-service-s3-object-lock": ["object lock"], "amazon-security-lake": ["security lake"], "aws-chatbot": ["chatbot", "slack"], "aws-control-tower": ["control tower"], "aws-config": ["config"], "amazon-vpc-lattice": ["lattice"], "aws-certificate-manager-certificate-authority": ["private ca", "certificate authority", "ca"], "aws-firewall-manager": ["firewall manager"], "amazon-data-firehose": ["firehose"],
    "aws-cloud-wan": ["cloud wan"], "amazon-vpc-flow-logs": ["flow log"], "aws-transit-gateway-attachment": ["attachment", "transit gateway"], "aws-organizations-account": ["account"], "aws-organizations-organizational-unit": ["ou", "organizational unit"],
