...
ICON_TERMS = {
    ...
    "aws-fargate": ["fargate"], "aws-lake-formation": ["lake formation"], "amazon-redshift": ["redshift"], "aws-glue-crawler": ["crawler"], "amazon-dynamodb-stream": ["stream"], "aws-glue-data-catalog": ["catalog", "metastore"],
