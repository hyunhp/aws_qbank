...
ICON_TERMS = {
    ...
    "aws-fargate": ["fargate"], "amazon-vpc-lattice": ["lattice"], "aws-certificate-manager-certificate-authority": ["private ca", "certificate authority", "ca"], "aws-firewall-manager": ["firewall manager"], "amazon-data-firehose": ["firehose"],
